...
- A [development Plexcord install](/docs/installing/plexcord)
...
<Tabs groupId="plugins-type">
    <TabItem label="Plugin" value="plugin">
        ...
        Use this location if you intend to [submit your plugin for inclusion in Plexcord](/docs/plugins/submission).
    </TabItem>
    <TabItem label="UserPlugin" value="userplugin">
...
<Tabs groupId="platform">
    <TabItem label="index.ts(x)" icon="seti:react" value="indexts">
    ...
    <TabItem label="README.md" icon="seti:markdown" value="readmemd">
        ...
        https://plexcord.club/plugins/YourPlugin.
    </TabItem>
    <TabItem label="native.ts" icon="seti:windows" value="nativets">
...
:::note
If this doesn't work for you, follow the [editor setup guide](/docs/installing/set-editor)
to install the Plexcord Companion extension.
:::
...
``` lang="ts" mark={["MutanPlex and contributors"]} code={
/*
...
If you want, you can change it from `MutanPlex and contributors` to your own name.
But this is not strictly necessary, you own the code either way (and are already included in the "contributors" part).

:::note
If this doesn't work for you, follow the [editor setup guide](/docs/installing/set-editor#installing-the-recommended-extensions)
to set up linting.
:::
